        ...
        if ($has_bookid == 1) {
            ...
            <div class="" style="padding:0px 50px;text-align: center">
                ...
                <form action="#" method="post" style="margin-top:10px;padding: 0px 50px;">
                    <h4 style="margin-bottom: 2px;">Cancellation Reason</h4>
                    <div class="row" >

                        <textarea class="form-control" name="reason" required="" placeholder="Write here your booking cancellation reason"></textarea>


                    </div>
                    <hr/>
                    <a class='btn btn-default pull-left' style='background: #d92229;border-radius: 15px;color: white;' href='<?php echo site_url("Movies/yourTicket/".$booking_id)?>'>Don't Want Cancel</a>
                    <button class='btn btn-default pull-right' style='background: #d92229;border-radius: 15px;color: white;' type='submit' name='payment'>Proceed For Cancellation</button>
                </form>
